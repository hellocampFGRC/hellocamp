  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { error } = await supabase.from("campos").insert([{
        ...
        programas_pdf: programasDocs, regras_termos_en,
        ...
        <div style={sectionStyle}>
          ...
          <div style={gridStyle}>
            ...
            <div>
              ...
              <input type="text" onChange={e => setFormData({...formData, racio_monitores: e.target.value})} style={inputStyle} />
            </div>
            ...
            <div style={{ gridColumn: '1 / -1', marginTop: '0.5rem' }}>
              ...
              <textarea rows={4} onChange={e => setFormData({...formData, regras_termos: e.target.value})} placeholder={isEn ? "E.g.: Cancellation policies, what to bring..." : "Ex: Política de cancelamento, regras, o que trazer..."} style={{...inputStyle, resize: 'vertical'}} />
            </div>
...
const inputBase = { width: '100%', padding: '0.875rem 1rem', borderRadius: '0.5rem', border: '1px solid #cbd5e1', backgroundColor: '#f8fafc', fontSize: '15px', color: '#0f172a', outline: 'none', boxSizing: 'border-box' as const, transition: 'border-color 0.2s, box-shadow 0.2s' };
