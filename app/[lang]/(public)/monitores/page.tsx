...
export default function MonitoresLandingPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return (
    <main className="min-h-screen bg-slate-50 font-sans text-slate-900 pb-20 selection:bg-blue-200">
      ...
      {/* HERO SECTION - Azul da Marca para Monitores */}
      <section className="relative overflow-hidden pt-28 pb-36 md:pt-40 md:pb-48 px-4 md:px-8 bg-[#124072] bg-gradient-to-br from-[#124072] via-[#0d2f54] to-[#06182c]">
        {/* Efeitos de Luz no Fundo */}
        <div className="absolute top-[-20%] right-[-10%] w-[600px] h-[600px] bg-white/5 rounded-full blur-[120px] pointer-events-none"></div>
        <div className="absolute bottom-[-20%] left-[-10%] w-[400px] h-[400px] bg-[#e2a41d]/10 rounded-full blur-[100px] pointer-events-none"></div>
        
        <div className="max-w-4xl mx-auto text-center relative z-10">
          
          {/* Badge Topo */}
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 border border-white/20 rounded-full text-[10px] md:text-xs font-black uppercase tracking-widest text-blue-100 mb-8 backdrop-blur-md shadow-sm">
            <span className="w-2 h-2 rounded-full bg-[#e2a41d] animate-pulse"></span>
          ...
          <p className="text-lg md:text-xl text-blue-100/80 font-medium mb-12 max-w-2xl mx-auto leading-relaxed">
            {isEn 
          ...
          {/* Botões CTA com alto contraste (Amarelo) */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link 
              href={`/${lang}/monitores/registo`}
              className="w-full sm:w-auto bg-[#e2a41d] hover:bg-[#d4991b] text-[#124072] font-black uppercase tracking-widest text-sm px-10 py-4 md:py-5 rounded-xl shadow-[0_0_40px_-10px_rgba(226,164,29,0.5)] transition-all hover:-translate-y-1 no-underline border border-[#e2a41d]"
            >
          ...
          {/* Trust Indicators */}
          <div className="mt-12 flex flex-wrap items-center justify-center gap-4 md:gap-8 text-xs md:text-sm font-bold text-blue-200">
            <div className="flex items-center gap-2"><span className="text-[#e2a41d]">✓</span> 100% Grátis</div>
            <div className="flex items-center gap-2"><span className="text-[#e2a41d]">✓</span> Sem Comissões</div>
            <div className="flex items-center gap-2"><span className="text-[#e2a41d]">✓</span> Seguro</div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-4 -mt-12 relative z-20 hidden md:block">
        <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100 p-8 grid grid-cols-3 gap-8 text-center divide-x divide-slate-100">
          ...
          <div>
            <div className="text-3xl font-black text-[#124072] mb-1">€0</div>
      ...
      <section className="max-w-6xl mx-auto px-4 md:px-8 py-20 md:py-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 relative">
          ...
          <div className="relative group">
            <div className="w-24 h-24 bg-white border-4 border-slate-50 text-[#124072] rounded-full flex items-center justify-center text-3xl mx-auto mb-8 shadow-sm group-hover:scale-110 transition-all duration-300">
              ✍️
            </div>
          ...
          <div className="relative group mt-8 md:mt-0">
            <div className="w-24 h-24 bg-[#124072] border-4 border-slate-100 text-white rounded-full flex items-center justify-center text-3xl mx-auto mb-8 shadow-md group-hover:scale-110 transition-all duration-300">
              💬
            </div>
            <div className="text-center px-4">
      ...
      <section className="bg-white border-y border-slate-200">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-8 md:p-16 lg:p-24 flex flex-col justify-center">
              ...
              <ul className="space-y-10">
                <li className="flex gap-5">
                  <div className="w-12 h-12 rounded-2xl bg-blue-50 text-[#124072] flex items-center justify-center flex-shrink-0 text-xl shadow-sm border border-blue-100">€</div>
                  <div>
                ...
                <li className="flex gap-5">
                  <div className="w-12 h-12 rounded-2xl bg-[#e2a41d]/10 text-[#e2a41d] flex items-center justify-center flex-shrink-0 text-xl shadow-sm border border-[#e2a41d]/20">🛡️</div>
                  <div>
                ...
                <li className="flex gap-5">
                  <div className="w-12 h-12 rounded-2xl bg-slate-100 text-slate-600 flex items-center justify-center flex-shrink-0 text-xl shadow-sm border border-slate-200">🚀</div>
                  <div>
            ...
            {/* Direita: CTA Visual */}
            <div className="bg-[#124072] p-8 md:p-16 lg:p-24 flex flex-col justify-center text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <Link 
                  href={`/${lang}/monitores/registo`}
                  className="inline-block w-full sm:w-auto bg-[#e2a41d] hover:bg-[#d4991b] text-[#124072] font-black uppercase tracking-widest text-sm px-10 py-5 rounded-xl shadow-lg transition-all hover:-translate-y-1 no-underline"
                >
