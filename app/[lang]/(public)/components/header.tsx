        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center justify-center gap-6 xl:gap-8 flex-1">
            <div className="relative group py-2">
              <button className="flex items-center gap-1.5 text-sm font-bold text-slate-700 hover:text-[#e2a41d] transition-colors bg-transparent border-none cursor-pointer">
                {isEn ? 'Camps' : 'Campos'}
              ...
              <div className="absolute left-1/2 -translate-x-1/2 mt-2 w-56 bg-white border border-slate-100 rounded-xl shadow-xl p-2 hidden flex-col z-50 group-hover:flex">
                <Link href={`/${lang}/pesquisa?categoria=Aventura %26 Natureza`} className="px-4 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50 hover:text-[#e2a41d] rounded-lg">Aventura & Natureza</Link>
                <Link href={`/${lang}/pesquisa?categoria=Desporto`} className="px-4 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50 hover:text-[#e2a41d] rounded-lg">Desporto</Link>
                <Link href={`/${lang}/pesquisa?categoria=Artes %26 Criatividade`} className="px-4 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50 hover:text-[#e2a41d] rounded-lg">Artes & Criatividade</Link>
              </div>
            </div>
            ...
            <Link href={`/${lang}/institucional`} className="text-sm font-bold text-slate-700 hover:text-[#167524] transition-colors">
              {isEn ? 'Public Camps' : 'Câmaras e Juntas'}
            </Link>

            <Link href={`/${lang}/guia-pais`} className="text-sm font-bold text-slate-700 hover:text-[#e2a41d] transition-colors">
              {isEn ? 'Parents Guide' : 'Guia Pais'}
            </Link>

            <Link href={`/${lang}/parceiro`} className="text-sm font-bold text-slate-700 hover:text-[#167524] transition-colors">
              {isEn ? 'Partners' : 'Parceiros'}
            </Link>

            <Link href={`/${lang}/monitores`} className="flex items-center gap-2 text-sm font-bold text-slate-700 hover:text-[#124072] transition-colors">
              <span className="w-1.5 h-1.5 rounded-full bg-[#124072]"></span>
